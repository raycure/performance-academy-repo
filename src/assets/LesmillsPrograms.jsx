export const lesMillsPrograms = {
	'GRUP FITNESS PROGRAMLARI': [
		...
		},
		{
			...
			whyYou: "RPM, yeni üyelerin fitness'a hızla aşık olmasını sağlamanın harika bir yoludur.  Bu tür bir egzersizde yeniyseler, RPM yolculuklarında kardiyo sonuçlarını çok yakında görecekler ve motive kalmalarını ve geri dönmeye devam etmeleri için ilham almalarını sağlayacaklar.\nBir Bisiklet stüdyosu, fitness butiklerini kendi oyunlarında alt etmenin ve üyelerinize sunulan seçenekleri çeşitlendirmenin de harika bir yoludur.",
